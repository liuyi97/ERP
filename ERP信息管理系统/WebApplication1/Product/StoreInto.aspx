<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoreInto.aspx.cs" Inherits="WebApplication1.Product.StoreInto" %>
    ...
    <script src="../Script/jquery-1.8.3.min.js"></script>
      <script type="text/javascript">
          function kuqu(id) {
              ...
              window.opener.document.getElementById("txtInto").value = id;
              window.close();
          }
    </script>
</body>
