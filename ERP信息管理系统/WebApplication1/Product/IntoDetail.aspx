<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IntoDetail.aspx.cs" Inherits="WebApplication1.Product.IntoDetail" %>
...
<body>
    <form id="form1" runat="server">
        <div id="big">
            <div id="Detail">
                <h2 style="text-align: center;">入库明细单</h2>
                <table class="tiao" id="tabOne">
                    <tr>
                        <td><span>入库单号：</span><asp:TextBox ID="txtID" runat="server"></asp:TextBox></td>
                    ...
                    <tr>
                        <td><span>入库日期：</span><asp:TextBox ID="txtTradeDate" runat="server"></asp:TextBox></td>
                    </tr>
                    <tr>
