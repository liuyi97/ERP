<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductOutHouse.aspx.cs" Inherits="WebApplication1.Product.ProductOutHouse" %>
...
<body>
    <form id="form1" runat="server">
        <div id="big">
            <div id="IntoHouse">
                <h2 style="text-align: center;">商品出库</h2>
                <table class="tiao" id="tabOne">
                    <tr>
                        ...
                        <td><span>出库类型：</span><asp:DropDownList ID="DDLIntoType" runat="server" Height="20px" Width="148px"></asp:DropDownList></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="btnCreate" runat="server" Text="生成出库订单" OnClick="btnCreate_Click" /></td>
                    </tr>
