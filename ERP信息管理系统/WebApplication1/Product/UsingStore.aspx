<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsingStore.aspx.cs" Inherits="WebApplication1.Product.UsingStore" %>
    ...
    <script src="../Script/jquery-1.8.3.min.js"></script>
      <script type="text/javascript">
          function kuqu(id) {
              ...
              window.opener.document.getElementById("txtOut").value = id;
              window.close();
          }
    </script>
</body>
