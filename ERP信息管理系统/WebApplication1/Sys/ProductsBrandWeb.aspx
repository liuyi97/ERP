<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductsBrandWeb.aspx.cs" Inherits="WebApplication1.Sys.ProductsBrandWeb" %>
...
<body>
    <form id="form1" runat="server">
        <div id="you">
            <div><a href="#">乐易拍信息系统</a>><a href="#">系统设置</a>>商品品牌</div>
            <div id="ku1">
                <table>
                    <tr>
                        <td>品牌名称：</td>
        ...
        <script type="text/javascript">
            function ProductsBrandbianji(id) {
                ...
                $.ajax({
                    ...
                    type: "post",
                    dataType: "json",
                    url: "handler/ProductsBrandID.ashx",
                    success: function (data) {
                        $(".t4").val(id);
                        $(".t1").val(data[0]["BrandName"]);
                        $(".t2").val(data[0]["Description"]);
                        $(".t5").val(data[0]["State"]);
                    }
                })
            }
            function ProductsBrandshanchu(id) {
                $.ajax({
                    data: { "id": id },
                    type: "post",
                    dataType: "Text",
                    url: "handler/ProductsBrandDelete.ashx",
                    success: function (data) {
                        if (data == "True") {
            ...
            $(function () {
                $(".t3").click(function () {
                    $.ajax({
                        ...
                        type: "post",
                        dataType: "Text",
                        url: "handler/ProductsBrandUpdate.ashx",
                        success: function (data) {
                            if (data == "True") {
                ...
                $("#tab").datagrid({
                    url: "handler/ProductsBrandALL.ashx",
                    columns: [[
                    { "title": "编号", "field": "BrandID", width: 20, "align": "center" },
                    { "title": "名称", "field": "BrandName", width: 20, "align": "center" },
                     ...
                     { "title": "状态", "field": "State", width: 20, "align": "center" },
                    {
                        "title": "编辑", "field": "nu", width: 20, "align": "center", formatter: function (value, row, index) {
                            return "<a href='javascript:ProductsBrandbianji(" + row.BrandID + ")'>编辑</a>"
                        }
                    },
                    {
                        "title": "删除", "field": "num", width: 20, "align": "center", formatter: function (value, row, index) {
                            return "<a href='javascript:ProductsBrandshanchu(" + row.BrandID + ")'>删除</a>"
                        }
                    }
                    ]],
                    width: 600,
