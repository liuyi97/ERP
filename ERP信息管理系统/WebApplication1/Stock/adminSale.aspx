<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminSale.aspx.cs" Inherits="WebApplication1.Stock.adminSale" %>
...
<body>
    ...
    <div  id="main">
    <h2 style="margin-left:325px;margin-top:10px;">商品出库管理</h2>
        <div id="top">
            单据编号：<asp:TextBox ID="TextBox1" Width="90px" runat="server"></asp:TextBox>
         ...
         $(function () {
             ...
             $("#box").datagrid({
                 ...
                 columns: [[
                     ...
                     { field: "SalesOutID", title: "订单编号", align: "center", width: 140 },
             ...
             $("#Button3").linkbutton({
                 onClick: function () {
                     ...
                     $.ajax({
                         url: "ashx/adminSaleDelete.ashx?saleid=" + s,
                         type: "post",
                         dataType: "Text",
             ...
             $("#Button2").linkbutton({
                 onClick: function () {
                     ...
                     var obj = 1;
                     var SalesOutID = c.SalesOutID;
                     $.ajax({
                         url: "ashx/adminSaleUpdate.ashx?statename=" + obj + "&SalesOutID=" + SalesOutID,
                         type: "post",
                         dataType: "text",
                         success: function (data) {
                             if (data == "True") {
             ...
             $("#Button1").linkbutton({
                 onClick: function () {
                     ...
                     $("#box").datagrid({
                         url: "ashx/adminSale.ashx?saleid=" + outid + "&create=" + create + "&tradetime=" + tradetime + "&statename=" + statename,
                         pagination: true,
                         pageSize: 5,
                         height: 200,
                         pageList: [5, 10, 15, 20],
